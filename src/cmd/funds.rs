    ...
    match cmd {
        FundsCommand::Deposit {
            ...
            let options = FundingOptions {
                ...
                evm_merkle_payments_address: environment_details.evm_details.merkle_payments_address,
            ...
            let network = match environment_details.evm_details.network {
                ...
                EvmNetwork::Custom => {
                    if let (
                        ...
                        environment_details.evm_details.data_payments_address.as_ref(),
                        environment_details.evm_details.merkle_payments_address.as_ref(),
                        environment_details.evm_details.payment_token_address.as_ref(),
